...
A personal portfolio site for Divyang Katariya, Graphic & Packaging Designer.
...
1. Create a new repository on GitHub (e.g. `divyang-portfolio`).
2. Upload these files (`index.html`, `style.css`, `script.js`, `images/`) to the repo — either via the GitHub web UI ("Add file → Upload files") or with git:
   ...
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/divyang-portfolio.git
   git push -u origin main
   ```
3. In the repo, go to **Settings → Pages**.
4. Under "Build and deployment", set **Source** to `Deploy from a branch`, branch `main`, folder `/ (root)`. Save.
5. GitHub will give you a live URL, usually:
   `https://YOUR-USERNAME.github.io/divyang-portfolio/`
